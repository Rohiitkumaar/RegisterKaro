      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center">
        <div className="md:w-1/2 mb-8 md:mb-0">
          ...
          <div className="flex flex-col md:flex-row justify-between">
              ...
              <defs>
                ...
                >
                  ...
                  <feBlend
                    ...
                    result="effect1_dropShadow_6038_27"
                  />
                  <feBlend
                    mode="normal"
                    in="SourceGraphic"
                    in2="effect1_dropShadow_6038_27"
                    result="shape"
                  />
                </filter>
                <filter
                  id="filter1_d_6038_27"
                  x="18.6667"
                  y="16"
                  width="22.6667"
                  height="28"
            ...
            <span>
              <h3 className="text-xl font-bold m-3 mb-2">
                Explore ideas together
              </h3>
              <p className=" leading-relaxed ml-3">
          ...
          <div>
            <div className="flex flex-col md:flex-row justify-between">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g filter="url(#filter0_d_6038_39)">
                  <path
                    d="M2 29C2 13.536 14.536 1 30 1C45.464 1 58 13.536 58 29C58 44.464 45.464 57 30 57C14.536 57 2 44.464 2 29Z"
                    fill="#FFA229"
                    shape-rendering="crispEdges"
                  />
                  <g filter="url(#filter1_d_6038_39)">
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
                ...
                <defs>
                  ...
                  >
                    ...
                    <feBlend
                      mode="normal"
                      in2="BackgroundImageFix"
                      result="effect1_dropShadow_6038_39"
                    />
                    <feBlend
                      mode="normal"
                      in="SourceGraphic"
                      in2="effect1_dropShadow_6038_39"
                      result="shape"
                    />
                  </filter>
                  <filter
                    id="filter1_d_6038_39"
                    x="16"
                    y="16"
                    width="28"
                    height="29.3334"
